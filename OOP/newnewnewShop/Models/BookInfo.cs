...
namespace lab4_5
{
    public static class BookInfo
    {
        ...
        static BookInfo()
        {
            string fileName1 = @"C:\AllMine\Labs\OOP\newnewnewShop\lab4-5\lab4-5\lab4-5\Data\Book.json";
            string json1 = File.ReadAllText(fileName1);
            string fileName2 = @"C:\AllMine\Labs\OOP\newnewnewShop\lab4-5\lab4-5\lab4-5\Data\BookGenre.json";
        ...
        {
            string fileName1 = @"C:\AllMine\Labs\OOP\newnewnewShop\lab4-5\lab4-5\lab4-5\DataBook.json";
            string json = JsonSerializer.Serialize(books, options);
            File.WriteAllText(fileName1, json);
        }
    }
