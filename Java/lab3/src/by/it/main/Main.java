...
public class Main {
   //static Logger logger = Logger.getLogger("D:\\javalab\\lab3\\log\\log.log");
    public static void main(String[] args) throws IOException {
        Ceo ceo = new Ceo("ceo1", 444.3);
        //logger.log(Level.ERROR, "Wsda");
        ...
        Middle middle4 = new Middle("middle4", 12.45);
        Middle middle5 = new Middle("middle5", 1266.02);
        Middle middle6 = new Middle("middle6", 400.95);
        Middle middle7 = new Middle("middle7", 499.52);
