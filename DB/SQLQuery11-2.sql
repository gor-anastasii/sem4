...
DECLARE first_cursor CURSOR LOCAL FOR SELECT Преподаватели.Фамилия FROM Преподаватели;
...
VALUES
(8, 'Станишевская', 'Мария', 'Владиславовна', '3456434', 6);

DECLARE @name2 varchar(200), @list2 varchar(600) = '';
DECLARE first_cursor2 CURSOR LOCAL dynamic /*static*/ FOR SELECT Преподаватели.Фамилия FROM Преподаватели;
--deallocate first_cursor2;

OPEN first_cursor2;
delete Преподаватели where Фамилия like 'Станишевская';
...
DECLARE first_cursor3 CURSOR LOCAL static FOR SELECT Преподаватели.Фамилия FROM Преподаватели;
